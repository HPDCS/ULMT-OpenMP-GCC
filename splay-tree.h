...
# define splay_tree_hp_list_mark_node  \
    splay_tree_name (splay_tree_prefix, splay_tree_hp_list_mark_node)
# define splay_tree_hp_list_insert  \
    splay_tree_name (splay_tree_prefix, splay_tree_hp_list_insert)
# define splay_tree_hp_list_remove  \
    splay_tree_name (splay_tree_prefix, splay_tree_hp_list_remove)
...
struct splay_tree_node_s {
  /* This structure must be the first field, as we cast
     prio_splay_tree_node to splay_tree_key throughout.  */
...
struct splay_tree_s {
  ...
  /* HP-LIST */
  int num_marked;
  splay_tree_node highest_marked;
};
...
extern int splay_tree_hp_list_mark_node (splay_tree, splay_tree_node, bool);
extern int splay_tree_hp_list_insert (splay_tree, splay_tree_node, bool);
extern int splay_tree_hp_list_remove (splay_tree, splay_tree_key);
...
#    undef splay_tree_hp_list_mark_node
#    undef splay_tree_hp_list_insert
