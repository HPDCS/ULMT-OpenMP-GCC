...
struct gomp_task_icv gomp_global_icv = {
  ...
  .nest_var = false,
  .wf_sched_var = false,
  .untied_block_var = true,
  .ult_var = false,
  .ult_stack_size = ULT_STACK_SIZE,
#if defined HAVE_TLS || defined USE_EMUTLS
  .text_section_start = NULL,
...
handle_omp_display_env (unsigned long stacksize, int wait_policy)
{
  ...
  fprintf (stderr, "  OMP_WORK_FIRST_SCHED = '%s'\n",
     gomp_global_icv.wf_sched_var ? "TRUE" : "FALSE");
  fprintf (stderr, "  OMP_UNTIED_BLOCK = '%s'\n",
     gomp_global_icv.untied_block_var ? "TRUE" : "FALSE");
  fprintf (stderr, "  OMP_ULT_THREADS = '%s'\n",
	   gomp_global_icv.ult_var ? "TRUE" : "FALSE");

  fprintf (stderr, "  OMP_ULT_STACK = '%lu'\n", gomp_global_icv.ult_stack_size);
...
initialize_env (void)
{
  ...
  parse_boolean ("OMP_WORK_FIRST_SCHED", &gomp_global_icv.wf_sched_var);
  parse_boolean ("OMP_UNTIED_BLOCK", &gomp_global_icv.untied_block_var);
